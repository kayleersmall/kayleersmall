...
for (var i = 0; i < movies.length; i++) {
  ...
  link.setAttribute('href', "movie?id=" + movies.indexOf(movies[i]))   // Sets each link's href as link with movies index
  console.log(movies.indexOf(movies[i]));                              // Logs index of each item
